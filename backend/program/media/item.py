...
class Show(MediaItem):
    ...
    def propagate_attributes_to_childs(self):
        ...
        # genres, country, is_anime isn't found in the data scrapped from the season or episode
        # so we need to propagate them from the show
        
        attributes = ["genres", "country", "is_anime"]
